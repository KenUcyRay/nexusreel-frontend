    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-lg shadow-lg p-4 sm:p-6 text-white">
            <div className="flex items-center">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
          <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
            <button
              ...
              className={`px-3 sm:px-4 py-2 rounded-lg transition-all text-sm sm:text-base ${chartType === 'daily' ? 'bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-white shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Daily
            </button>
            <button
              onClick={() => setChartType('monthly')}
              className={`px-3 sm:px-4 py-2 rounded-lg transition-all text-sm sm:text-base ${chartType === 'monthly' ? 'bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-white shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Monthly
            </button>
            <button
              onClick={() => setChartType('total')}
              className={`px-3 sm:px-4 py-2 rounded-lg transition-all text-sm sm:text-base ${chartType === 'total' ? 'bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-white shadow-lg' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Overall
            </button>
          </div>
            ...
            return (
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-4">
                  {/* Bar Chart */}
                  <div className="flex items-end justify-center h-32 space-x-1 overflow-x-auto bg-white p-2 rounded">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-4 sm:p-6">
                ...
                <div className="border p-4 sm:p-6 bg-gray-50">
